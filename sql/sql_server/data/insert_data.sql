...
-- Insert BookingGuest associations
-- Booking 1: Alice primary guest, Diana secondary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(1, 1, 1),
(1, 4, 0);

-- Booking 2: Bob primary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(2, 2, 1);

-- Booking 3: Charlie primary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(3, 3, 1);

-- Booking 4: Ethan primary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(4, 5, 1);

-- Booking 5: Bob primary guest, Alice secondary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(5, 2, 1),
(5, 1, 0);

-- Booking 6: Diana primary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(6, 4, 1);

-- Booking 7: Ethan primary guest
INSERT INTO BookingGuest (bookingId, guestId, isPrimary) VALUES
(7, 5, 1);
